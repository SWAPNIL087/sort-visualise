...
//=-----------------
	...
	for (let i=start;i<=end;i++){
	 ...
	 draw(arr,pivotIndex,end);
	 yield ooo;
	let index = pivotIndex;
	//console.log("the index"+index)
		swa=true;

	yield* quickSort(arr,start,index-1);
	yield* quickSort(arr,index+1,end);
...
sort.addEventListener('click',function(){
	...
	draw(arr)*/
	var variablemade = quickSort(arr,0,arr.length-1);
								 //draw2(arr);
